        ...
        <div class="container mx-auto xl:max-w-7xl">
            <div class="-mx-auto flex flex-wrap">
                <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
                    <div class="mb-10 w-full">
                        ...
                        <p class="text-body-color mb-7 text-base">
                            Contacta con nuestro personal, y resuleve cualquier duda que tengas.
                        </p>
                ...
                <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
                    <div class="mb-10 w-full">
                        <h4 class="text-dark mb-9 text-lg font-semibold">Caraterísticas</h4>
                        <ul>
                            <li>
                                <a href="#"
                ...
                <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
                    <div class="mb-10 w-full">
                        <h4 class="text-dark mb-9 text-lg font-semibold">Compañía</h4>
                        <ul>
                            <li>
                                <a href="#"
                                    class="text-body-color hover:text-primary mb-2 inline-block text-base leading-loose">
                    ...
                    <div class="mb-10 w-full">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="#nosotros"
                                    class="text-body-color hover:text-primary mb-2 inline-block text-base leading-loose">
                                    Conoce nuestros desarrolladores
                                </a>
                            </li>
                            <li>
                                <a href="#"
                    ...
                    <div class="mb-10 w-full">
                        ...
                        <div class="mb-6 flex items-center">
                            <a href="javascript:void(0)"
                                class="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-blue-700 sm:mr-4 lg:mr-3 xl:mr-4">
                            ...
                            <a href="javascript:void(0)"
                                class="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-red-500 sm:mr-4 lg:mr-3 xl:mr-4">
                                <svg width="16" height="12" viewBox="0 0 16 12" class="fill-current">
                                    <path
                        ...
                        <p class="text-body-color text-base">&copy; 2022 BiancaSoft</p>
                    </div>
                </div>
            </div>
        </div>
        <div>
            <span class="absolute top-[15rem] bottom-0 z-[-1]">
                <svg width="85" height="85" viewBox="0 0 217 229" fill="none"
