       ...
       <nav class="flex flex-row flex-nowrap items-center justify-between mt-0 py-2 px-6 border-b border-gray-200 bg-white dark:bg-gray-800 dark:border-gray-800" id="desktop-menu">
          ...
          <a class="flex items-center py-2 ltr:mr-4 rtl:ml-4 text-xl" href="{{ route('dashboard') }}">
            ...
            <span class="text-2xl font-semibold text-gray-200 hidden lg:block dark:text-gray-300">
              ...
              </svg><span class="text-gray-700 dark:text-gray-200">Translator Speech</span></span>
          </a>
          ...
          <ul class="flex ltr:ml-auto rtl:mr-auto mt-2 mt-0">
            ...
            <li x-data="{ open: false }" class="relative">
              <a href="#" class="block py-3 px-4 flex text-sm rounded-full focus:outline-none" id="messages" >
            ...
            <!-- notification -->
            <li x-data="{ open: false }" class="relative">
              <a href="#" class="block py-3 px-4 flex text-sm rounded-full focus:outline-none" id="notify" >
                  <div class="relative inline-block">
            ...
            <!-- profile -->
            <li x-data="{ open: false }" class="relative">
              <a href="#" class="px-3 flex text-sm rounded-full focus:outline-none" id="user-menu-button">
                  <div class="relative">
        ...
        <!-- desktop menu -->
        <div x-bind:aria-expanded="open" :class="{ 'block lg:hidden': open, 'hidden lg:flex': !(open) }" class="lg:flex lg:flex-row lg:flex-nowrap lg:items-center lg:justify-between mt-0 px-6 color_nav_dashboard" id="desktp-menu">
          <!-- menu -->
          <ul class="flex flex-col lg:ltr:mr-auto lg:rtl:ml-auto mt-3 lg:flex-row lg:mt-0">
            <!-- dropdown -->
            <li class="relative">
              <a id="dropdown-01" class="block py-3 lg:py-7 px-0 lg:px-4 hover:text-gray-300 color_nav_fuente" href="{{ route('dashboard') }}">
            ...
            <li class="relative" x-data="{ open: false }"  @keydown.escape.stop="open = false" @click.away="open = false">
              <a id="dropdown-02" class="block py-3 lg:py-7 px-0 lg:px-4 hover:text-gray-300 color_nav_fuente" href="javascript:;" @click="open = !open" aria-haspopup="true" x-bind:aria-expanded="open" :class="{ 'text-gray-300': open }">
               Menú1
                <!-- caret -->
              ...
              <ul class="block lg:absolute ltr:border-l-2 rtl:border-r-2 border-gray-400 lg:ltr:border-l-0 lg:rtl:border-r-0 lg:border-t-2 lg:border-indigo-500 rounded rounded-t-none top-full z-50 py-0.5 ltr:text-left rtl:text-right lg:bg-white lg:shadow-md lg:text-gray-600 dark:bg-gray-800 dark:border-gray-700" style="min-width: 12rem;display:none;" x-description="Dropdown menu" x-show="open" role="menu" aria-orientation="vertical" aria-labelledby="dropdown-02" x-transition:enter="transition duration-200" x-transition:enter-start="transform opacity-0 translate-y-4" x-transition:enter-end="transform opacity-100 translate-y-0" x-transition:leave="transition translate-y-4" x-transition:leave-start="transform opacity-100 translate-y-0" x-transition:leave-end="transform opacity-0 translate-y-4">
                <!--submenu-->
                <li class="relative" x-data="{ open: false }" @keydown.escape.stop="open = false" @click.away="open = false">
                  <a id="submenu-01" class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-gray-300 lg:hover:text-indigo-500 color_nav_fuente1" href="javascript:;"@click="open = !open" aria-haspopup="true" x-bind:aria-expanded="open" :class="{ 'text-gray-300 lg:text-indigo-500': open }">
                    Submenú1
                    <!-- caret -->
                  ...
                  <ul class="block lg:absolute lg:ltr:left-full lg:rtl:right-full lg:ltr:right-auto lg:rtl:left-auto lg:transform ltr:pl-6 rtl:pr-6 lg:ltr:pl-0 lg:rtl:pr-0 lg:border-t-2 border-indigo-500 rounded rounded-t-none top-full z-50 py-0.5 ltr:text-left rtl:text-right lg:-mt-11 ml-0 mr-0 lg:bg-white lg:shadow-md dark:bg-gray-800 dark:border-gray-700" style="min-width: 12rem;display:none;" x-description="Dropdown menu" x-show="open" role="menu" aria-orientation="vertical" aria-labelledby="submenu-01" x-transition:enter="transition duration-200" x-transition:enter-start="transform opacity-0 translate-y-4" x-transition:enter-end="transform opacity-100 translate-y-0" x-transition:leave="transition translate-y-4" x-transition:leave-start="transform opacity-100 translate-y-0" x-transition:leave-end="transform opacity-0 translate-y-4">
                    <li><a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-gray-300 lg:hover:text-indigo-500 color_nav_fuente1" href="#">Opción2</a></li>
                    <li><a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-gray-300 lg:hover:text-indigo-500 color_nav_fuente1" href="#">Opción1</a></li>
                 </ul>
                </li>
  
                <!--submenu-->
                <li class="relative">
                  <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-gray-300 lg:hover:text-indigo-500 color_nav_fuente1" href="#">Opción1</a>
                </li>
                <li class="relative">
                  <a class="block w-full py-2 px-6 clear-both whitespace-nowrap hover:text-gray-300 lg:hover:text-indigo-500 color_nav_fuente1" href="#">Opción2</a>
                </li>
              </ul>
            </li>
          ...
          <form method="POST" action="{{ route('logout') }}" x-data>
              ...
              <div class="text-center lg:block my-6 lg:my-auto">
                  <button class="py-2 px-4 text-sm inline-block text-center rounded leading-5 text-gray-300 bg-indigo-500 border border-indigo-500 hover:text-gray-200 hover:bg-indigo-600 hover:ring-0 hover:border-indigo-600 focus:bg-indigo-600 focus:border-indigo-600 focus:outline-none focus:ring-0" target="_blank" rel="noopener" href="layout-topnav.html#">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="inline ltr:mr-1 rtl:ml-1 feather feather-log-out"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
                        Log Out
                  </button>
                </div>
          </form>
